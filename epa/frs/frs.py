...
class FRS(Envirofacts):
    """Python wrapper for the EPA's FRS API."""
    ...
    def frs_query(self, table_lst, column=None, value=None, **kwargs):
        """
        General-purpose FRS query function allowing queries on 1-3 tables.
        """
